...
function getCars(page = 1, limit = 7) {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield fetch(`http://localhost:3000/garage?_page${page}&_limit=${limit}`);
...
width="150.000000pt" height="75.000000pt" viewBox="0 0 1280.000000 640.000000"
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.init = void 0;
const render_main_page_1 = __importDefault(__webpack_require__(/*! ./render-main-page */ "./scripts/render-main-page.ts"));
const render_app_1 = __importDefault(__webpack_require__(/*! ./render-app */ "./scripts/render-app.ts"));
function init() {
    (0, render_main_page_1.default)();
    (0, render_app_1.default)();
}
exports.init = init;
alert('Ребят, правда, совсем нет времени, но обещаю доделать!');


/***/ }),

/***/ "./scripts/render-app.ts":
/*!*******************************!*\
  !*** ./scripts/render-app.ts ***!
  \*******************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const backend_1 = __webpack_require__(/*! ./backend */ "./scripts/backend.ts");
const carSvg_1 = __importDefault(__webpack_require__(/*! ./carSvg */ "./scripts/carSvg.ts"));
function createAppNavigation(app) {
    ...
    app === null || app === void 0 ? void 0 : app.append(nav);
}
function createSettingsField(app) {
    ...
    app === null || app === void 0 ? void 0 : app.append(settings);
}
function renderAppContols(app) {
    ...
    app === null || app === void 0 ? void 0 : app.append(controls);
}
function createCar(elem) {
    ...
    car.innerHTML = carSvg_1.default;
...
function renderCars(cars) {
    ...
    cars.forEach((elem) => {
        garageRaceField === null || garageRaceField === void 0 ? void 0 : garageRaceField.append(createCar(elem));
    });
}
function renderGarageFields(page) {
    return __awaiter(this, void 0, void 0, function* () {
        const test = yield (0, backend_1.getCars)(page);
        const { cars, xTotalCount, totalPages } = test;
        if (!xTotalCount || !totalPages)
            return;
...
function renderApp() {
    ...
    createGarage(app);
    mainContainer === null || mainContainer === void 0 ? void 0 : mainContainer.append(app);
...
exports["default"] = renderBasicPage;
...
const init_1 = __webpack_require__(/*! ./scripts/init */ "./scripts/init.ts");
(0, init_1.init)();
